...
angular.module('ngGrid').run(['$templateCache', '$interpolate', function($templateCache, $interpolate) {
  ...
  $templateCache.put('aggregateTemplate.html',
    ...
    "    <span class=\"ngAggregateText\">" + start + "row.label CUSTOM_FILTERS" + end + " (" + start + "row.totalChildren()" + end + " " + start + "AggItemsLabel" + end + ")</span>\n" +
    "    <div class=\"" + start + "row.aggClass()" + end + "\"></div>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('cellTemplate.html',
    "<div class=\"ngCellText\" ng-class=\"col.colIndex()\"><span ng-cell-text>" + start + "COL_FIELD CUSTOM_FILTERS" + end + "</span></div>"
  );
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "            <span class=\"ngLabel\">" + start + "i18n.ngTotalItemsLabel" + end + " " + start + "maxRows()" + end + "</span><span ng-show=\"filterText.length > 0\" class=\"ngLabel\">(" + start + "i18n.ngShowingItemsLabel" + end + " " + start + "totalFilteredItemsLength()" + end + ")</span>\n" +
    "        </div>\n" +
    "        <div class=\"ngFooterSelectedItems\" ng-show=\"multiSelect\">\n" +
    "            <span class=\"ngLabel\">" + start + "i18n.ngSelectedItemsLabel" + end + " " + start + "selectedItems.length" + end + "</span>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <div class=\"ngPagerContainer\" style=\"float: right; margin-top: 10px;\" ng-show=\"enablePaging\" ng-class=\"{'ngNoMultiSelect': !multiSelect}\">\n" +
    "        <div style=\"float:left; margin-right: 10px;\" class=\"ngRowCountPicker\">\n" +
    "            <span style=\"float: left; margin-top: 3px;\" class=\"ngLabel\">" + start + "i18n.ngPageSizeLabel" + end + "</span>\n" +
    "            <select style=\"float: left;height: 27px; width: 100px\" ng-model=\"pagingOptions.pageSize\" >\n" +
    "                <option ng-repeat=\"size in pagingOptions.pageSizes\">" + start + "size" + end + "</option>\n" +
    "            </select>\n" +
    "        </div>\n" +
    "        <div style=\"float:left; margin-right: 10px; line-height:25px;\" class=\"ngPagerControl\" style=\"float: left; min-width: 135px;\">\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageToFirst()\" ng-disabled=\"cantPageBackward()\" title=\"" + start + "i18n.ngPagerFirstTitle" + end + "\"><div class=\"ngPagerFirstTriangle\"><div class=\"ngPagerFirstBar\"></div></div></button>\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageBackward()\" ng-disabled=\"cantPageBackward()\" title=\"" + start + "i18n.ngPagerPrevTitle" + end + "\"><div class=\"ngPagerFirstTriangle ngPagerPrevTriangle\"></div></button>\n" +
    "            <input class=\"ngPagerCurrent\" min=\"1\" max=\"" + start + "currentMaxPages" + end + "\" type=\"number\" style=\"width:50px; height: 24px; margin-top: 1px; padding: 0 4px;\" ng-model=\"pagingOptions.currentPage\"/>\n" +
    "            <span class=\"ngGridMaxPagesNumber\" ng-show=\"maxPages() > 0\">/ " + start + "maxPages()" + end + "</span>\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageForward()\" ng-disabled=\"cantPageForward()\" title=\"" + start + "i18n.ngPagerNextTitle" + end + "\"><div class=\"ngPagerLastTriangle ngPagerNextTriangle\"></div></button>\n" +
    "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageToLast()\" ng-disabled=\"cantPageToLast()\" title=\"" + start + "i18n.ngPagerLastTitle" + end + "\"><div class=\"ngPagerLastTriangle\"><div class=\"ngPagerLastBar\"></div></div></button>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('gridTemplate.html',
    ...
    "        <div class=\"ngGroupPanelDescription\" ng-show=\"configGroups.length == 0\">" + start + "i18n.ngGroupPanelDescription" + end + "</div>\n" +
    "        <ul ng-show=\"configGroups.length > 0\" class=\"ngGroupList\">\n" +
    "            <li class=\"ngGroupItem\" ng-repeat=\"group in configGroups\">\n" +
    "                <span class=\"ngGroupElement\">\n" +
    "                    <span class=\"ngGroupName\">" + start + "group.displayName" + end + "\n" +
  ...
  $templateCache.put('headerCellTemplate.html',
    "<div class=\"ngHeaderSortColumn " + start + "col.headerClass" + end + "\" ng-style=\"{'cursor': col.cursor}\" ng-class=\"{ 'ngSorted': !col.noSortVisible() }\">\n" +
    "    <div ng-click=\"col.sort($event)\" ng-class=\"'colt' + col.index\" class=\"ngHeaderText\">" + start + "col.displayName" + end + "</div>\n" +
    ...
    "    <div class=\"ngSortPriority\">" + start + "col.sortPriority" + end + "</div>\n" +
  ...
  $templateCache.put('menuTemplate.html',
    ...
    "        <input placeholder=\"" + start + "i18n.ngSearchPlaceHolder" + end + "\" type=\"text\" ng-model=\"filterText\"/>\n" +
    "    </div>\n" +
    "    <div ng-show=\"showColumnMenu\">\n" +
    "        <span class=\"ngMenuText\">" + start + "i18n.ngMenuText" + end + "</span>\n" +
    "        <ul class=\"ngColList\">\n" +
    "            <li class=\"ngColListItem\" ng-repeat=\"col in columns | ngColumns\">\n" +
    "                <label><input ng-disabled=\"col.pinned\" type=\"checkbox\" class=\"ngColListCheckbox\" ng-model=\"col.visible\"/>" + start + "col.displayName" + end + "</label>\n" +
    "\t\t\t\t<a title=\"Group By\" ng-class=\"col.groupedByClass()\" ng-show=\"col.groupable && col.visible\" ng-click=\"groupBy(col)\"></a>\n" +
    "\t\t\t\t<span class=\"ngGroupingNumber\" ng-show=\"col.groupIndex > 0\">" + start + "col.groupIndex" + end + "</span>          \n" +
    "            </li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "</div>"
  ...
  $templateCache.put('rowTemplate.html',
    "<div ng-style=\"{ 'cursor': row.cursor }\" ng-repeat=\"col in renderedColumns\" ng-class=\"col.colIndex()\" class=\"ngCell " + start + "col.cellClass" + end + "\">\n" +
