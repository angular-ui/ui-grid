(function () {
        ...
        compile: function () {
          return {
            pre: function ($scope, $elm, $attrs, uiGridCtrl) {
              ...
              $scope.showButton = !uiGridCtrl.grid.options.exporterSuppressButton;

              uiGridCtrl.grid.exporter.gridElm = $elm;
              uiGridCtrl.grid.exporter.$scope = $scope;
              
              $scope.showMenu = function() {
                uiGridExporterService.showMenu( uiGridCtrl.grid );
              };

              gridUtil.getTemplate(uiGridCtrl.grid.options.exporterHeaderTemplate)
              .then(function (contents) {
                contents = contents.replace( uiGridExporterConstants.BUTTON_LABEL, uiGridCtrl.grid.options.exporterButtonLabel);
  ...
  module.directive('uiGridExporterMenu', ['$timeout', 'gridUtil',
    function ($timeout, gridUtil) {
      return {
        ...
        link: function ($scope, $elm, $attr, controllers) {
          ...
          $scope.$on('toggleExporterMenu', function () {
            if ( $scope.shown ){
          ...
          $scope.$on('clearExporterMenu', function () {
            $scope.shown = false;
          });
