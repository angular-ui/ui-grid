...
//    $templateCache.put('ui-grid/cellEditor', '<div ui-grid-editor></div>');
  ...
  describe('initialisation: ', function () {
    ...
    describe('register api,', function() {
      ...
      beforeEach(function() {
        spyOn( uiGridRowEditService, 'endEditCell' ).and.callFake( function() {} );
        spyOn( uiGridRowEditService, 'beginEditCell' ).and.callFake( function() {} );
        spyOn( uiGridRowEditService, 'cancelEditCell' ).and.callFake( function() {} );
      });

      it('listener in place on edit events', function () {
  ...
  describe( 'endEditCell: ', function() {
    ...
    beforeEach( function() {
      called = false;
      spyOn( uiGridRowEditService, 'saveRow' ).and.callFake( function() {
