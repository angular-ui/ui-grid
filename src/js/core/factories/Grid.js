 ...
 */
   ...
   * 1. If there is no sort set then the resulting rows should follow the order of the rows in the data array
   * 2. Keep the existing gridRow that is associated with each entity, meaning settings like selection are retained
   * 3. Any gridRows no longer in the data need to be cleaned up from the hashMap to avoid memory leakage
   * 
   */
